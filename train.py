    ...
    while not mon_sess.should_stop():
      ...
      if step_var >= FLAGS.max_steps - 1:
        ...
        with tf.io.gfile.GFile(path.join(FLAGS.train_dir, "stats.csv"), "w") as fout:
          ...
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 0, np.argmin(distance_var[0, :, 0]), 0], undef_dist_var[0, 0, np.argmin(distance_var[0, :, 0]), 1], undef_dist_var[0, 0, np.argmin(distance_var[0, :, 0]), 2]))
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 0, np.argmin(distance_var[0, :, 0]), 3], undef_dist_var[0, 0, np.argmin(distance_var[0, :, 0]), 4], undef_dist_var[0, 0, np.argmin(distance_var[0, :, 0]), 5]))
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 0, np.argmin(distance_var[0, :, 0]), 6], undef_dist_var[0, 0, np.argmin(distance_var[0, :, 0]), 7], undef_dist_var[0, 0, np.argmin(distance_var[0, :, 0]), 8]))
          fout.write("Minimum 1\n")
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 1, np.argmin(distance_var[0, :, 0]), 0], undef_dist_var[0, 1, np.argmin(distance_var[0, :, 0]), 1], undef_dist_var[0, 1, np.argmin(distance_var[0, :, 0]), 2]))
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 1, np.argmin(distance_var[0, :, 0]), 3], undef_dist_var[0, 1, np.argmin(distance_var[0, :, 0]), 4], undef_dist_var[0, 1, np.argmin(distance_var[0, :, 0]), 5]))
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 1, np.argmin(distance_var[0, :, 0]), 6], undef_dist_var[0, 1, np.argmin(distance_var[0, :, 0]), 7], undef_dist_var[0, 1, np.argmin(distance_var[0, :, 0]), 8]))
          fout.write("Maximum 0\n")
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 0, np.argmax(distance_var[0, :, 0]), 0], undef_dist_var[0, 0, np.argmax(distance_var[0, :, 0]), 1], undef_dist_var[0, 0, np.argmax(distance_var[0, :, 0]), 2]))
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 0, np.argmax(distance_var[0, :, 0]), 3], undef_dist_var[0, 0, np.argmax(distance_var[0, :, 0]), 4], undef_dist_var[0, 0, np.argmax(distance_var[0, :, 0]), 5]))
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 0, np.argmax(distance_var[0, :, 0]), 6], undef_dist_var[0, 0, np.argmax(distance_var[0, :, 0]), 7], undef_dist_var[0, 0, np.argmax(distance_var[0, :, 0]), 8]))
          fout.write("Maximum 1\n")
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 1, np.argmax(distance_var[0, :, 0]), 0], undef_dist_var[0, 1, np.argmax(distance_var[0, :, 0]), 1], undef_dist_var[0, 1, np.argmax(distance_var[0, :, 0]), 2]))
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 1, np.argmax(distance_var[0, :, 0]), 3], undef_dist_var[0, 1, np.argmax(distance_var[0, :, 0]), 4], undef_dist_var[0, 1, np.argmax(distance_var[0, :, 0]), 5]))
          fout.write("{0},{1},{2}\n".format(undef_dist_var[0, 1, np.argmax(distance_var[0, :, 0]), 6], undef_dist_var[0, 1, np.argmax(distance_var[0, :, 0]), 7], undef_dist_var[0, 1, np.argmax(distance_var[0, :, 0]), 8]))
          # for j in range(2):
